...
public class ParallelAiAgentWorkflow extends AbstractAiAgentWorkflow {
    // TODO allow configuring the parallelism

    @Override
    protected WorkflowAgent workflowAgent(RunContext runContext, Object[] assistants) {
        return AgenticServices.parallelBuilder(WorkflowAgent.class)
